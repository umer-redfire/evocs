...
const Navbar = () => {
  ...
  return (
    <div className="app-navbar flex-shrink-0">
      ...
      <div
        onClick={() => setUserAvatarClass(!userAvatarClass)}
      ...
      >
        <div
          className={clsx(
            ...
            userAvatarClass
              ? 'cursor-pointer symbol symbol-35px symbol-md-40px show menu-dropdown'
        ...
        <HeaderUserMenu avatarClass={userAvatarClass} />
      </div>

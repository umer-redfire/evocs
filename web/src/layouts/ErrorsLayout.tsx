...
import { useThemeMode } from 'src/theme/_metronic/partials/layout/theme-mode/ThemeModeProvider';

const BODY_CLASSES = ['bgi-size-cover', 'bgi-position-center', 'bgi-no-repeat'];
type ErrorsLayoutChildren = {
  children: React.ReactNode;
};
const ErrorsLayout = ({ children }: ErrorsLayoutChildren) => {
